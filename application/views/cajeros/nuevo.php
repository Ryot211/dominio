...
<br>
<div class="container" >
    <form  action="<?php echo site_url('cajeros/guardarCajero');?>" method="post" enctype="multipart/form-data" class="p-4 border rounded bg-light"id="formularioCajero">

        <div class="mb-3">
            <label for="nombre"><b>Nombre:</b></label>
            <input type="text" name="nombre" id="nombre" placeholder="Ingrese el nombre del cajero" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="ubicacion"><b>Ubicacion:</b></label>
            <input type="text" name="ubicacion" id="ubicacion" placeholder="Ingrese la ubicacion del Cajero" class="form-control" required>
        </div>

        <div class="form-group">
            <label for="direccion"><b>Direccion:</b></label>
            <input type="text" name="direccion" id="direccion" placeholder="Ingrese la direccion de la Cajero" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="numserie" id="numserie" placeholder="Ingrese el numero de serie del Cajero" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="modelo"><b>Modelo:</b></label>
            <input type="text" name="modelo" id="modelo" placeholder="Ingrese el modelo del cajero" class="form-control" required>
        </div>

        <div class="form-group">
            <label for="estado"><b>Estado del cajero:</b></label>
            <input type="text" name="estado" id="estado" placeholder="Ingrese el estado del cajero" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="fecha_ins"><b>Fecha de Instalacion:</b></label>
            <input type="date" name="fecha_ins" id="fecha_ins" placeholder="Seleccione la fecha de instalacion del cajero" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="mantenimiento"><b>Fecha de Mantenimiento:</b></label>
            <input type="date" name="mantenimiento" id="mantenimiento" placeholder="Seleccione la fecha del ultimo mantenimiento del cajero" class="form-control" required>
        </div>
        <div class="form-group">
            <label for="Sucursal_ID"><b>Surcusal:</b></label>
